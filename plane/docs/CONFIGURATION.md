...
| `MCP_DEFAULT_PROJECT` | `SLONK` | Plane-идентификатор проекта по умолчанию (у Plane-проектов нет slug) |
| `MCP_ALLOWED_PROJECTS` | `SLONK` | comma-separated, проекты (по identifier/name/id), к которым MCP даёт доступ |
