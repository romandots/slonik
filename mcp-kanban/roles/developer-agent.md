...
Работает в отдельной git-worktree под задачу — не в основном working tree
клона. Подробности — в `CLAUDE.md` («Git workflow» → «Worktree (обязательно)»)
и в `docs/CONVENTIONS.md` («Git worktree»).
